...
- [ ] 1. Capture baseline and set up the working notes
  - [-] 1.1 Verify a clean tree and record the Baseline_Green_Set
  ...
  - [~] 1.2 Smoke check the baseline run
...
- [ ] 2. Run the detection pipeline
  - [~] 2.1 Run static analyzers over the codebase
  ...
  - [~] 2.2 Confirm references with manual zero-reference grep
...
- [ ] 3. Build the classification table
  - [~] 3.1 Classify every candidate into exactly one category
...
- [ ] 4. Batch A — remove unused imports and trivial local dead code
  - [~] 4.1 Apply Batch A removals
  ...
  - [~] 4.2 Verify Batch A against the baseline
...
- [ ] 5. Batch B — remove proven-dead private helpers per module
  - [~] 5.1 Apply Batch B removals one module (or small cluster) at a time
  ...
  - [~] 5.2 Verify Batch B against the baseline
    - **Property 1: No baseline-passing test regresses across any batch**
    - **Property 2: The working tree is green after every processed batch**
    - **Validates: Requirements 6.2, 6.3, 6.4**
...
- [ ] 7. Batch C — remove orphaned-by-dead helpers
  - [~] 7.1 Apply Batch C removals
  ...
  - [~] 7.2 Verify Batch C against the baseline
    - **Property 1: No baseline-passing test regresses across any batch**
    - **Property 2: The working tree is green after every processed batch**
    - **Validates: Requirements 6.2, 6.3, 6.4**
...
- [ ] 8. Batch D — remove genuinely speculative branches (conservative)
  - [~] 8.1 Apply Batch D removals
  ...
  - [~] 8.2 Verify Batch D against the baseline
    - **Property 1: No baseline-passing test regresses across any batch**
    - **Property 2: The working tree is green after every processed batch**
    - **Validates: Requirements 6.2, 6.3, 6.4**
...
- [ ] 9. Batch E — delete stale artifacts and update README
  - [~] 9.1 Delete the stale notebook and documentation artifacts
  ...
  - [~] 9.2 Remove the Notebooks section from README.md
  ...
  - [~] 9.3 Verify Batch E against the baseline
    - **Property 2: The working tree is green after every processed batch**
...
- [ ] 10. Final verification
  - [~] 10.1 Confirm removals and green suite
